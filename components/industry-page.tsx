...
import { bookingLink, type IndustryPage as IndustryPageContent } from "@/lib/site";
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 pb-20 pt-14 sm:px-6 sm:pt-18 lg:px-8 lg:pb-24 lg:pt-20">
          ...
          >
            ...
            <Link className="hover:text-slate-950" href="/seo-for-high-trust-service-businesses">
              High-trust SEO guide
            </Link>
            <span aria-hidden="true">/</span>
          ...
          <div className="space-y-5 lg:sticky lg:top-24">
            <Card className="rounded-[1.75rem] border-orange-200 bg-orange-50/70 p-6">
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-semibold text-slate-950">Specific pages beat vague pages</p>
                  <p className="mt-2 leading-7 text-slate-700">
                    These industry pages work best when they support the exact services, trust
                    signals, and questions buyers already care about.
                  </p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-6">
              ...
              <p className="mt-4 leading-7 text-slate-600">
                Better Search reviews the commercial pages, trust signals, and technical basics
                most likely to affect visibility and enquiry quality.
              </p>
              <a className={buttonVariants({ size: "lg" })} href={bookingLink}>
                Book a free visibility audit
                <ArrowRight className="h-5 w-5" aria-hidden="true" />
