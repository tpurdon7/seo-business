...
import { bookingLink, type TrustPage as TrustPageContent } from "@/lib/site";
              ...
              <div className="mt-6 space-y-4">
                {page.principles.map((principle) => (
                  <div
                    ...
                    key={principle.title}
                  >
                    <p className="font-semibold text-slate-950">{principle.title}</p>
          ...
          <div className="space-y-5 lg:sticky lg:top-24">
            ...
            <Card className="p-6">
              ...
              <p className="mt-4 leading-7 text-slate-600">
                We review the pages, trust signals, and technical basics most likely to affect
                how your business is found and compared.
              </p>
              <a className={buttonVariants({ size: "lg" })} href={bookingLink}>
                Book a free visibility audit
                <ArrowRight className="h-5 w-5" aria-hidden="true" />
